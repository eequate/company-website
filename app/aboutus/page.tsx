...
export default function FeatureGrid() {
  ...
  const testimonials = [
    {
      ...
      imageUrl: "/assets/images/person1.webp",
      heading: "Outstanding Experience",
      description:
        "Utilizing artificial intelligence to streamline, refine, and elevate user experiences for more intelligent outcomes.",
      bgImage: "/assets/images/testimonial.webp",
    },
    {
      name: "Emily Chen",
      ...
      description:
        "Leveraging cutting-edge technology to enhance productivity and drive success.",
      bgImage: "/assets/images/testimonial.webp",
    },
    {
      name: "Alex Rodriguez",
      ...
      description:
        "Integrating innovative strategies to fuel growth and drive sustainable progress.",
      bgImage: "/assets/images/testimonial.webp",
    },
  ];
  ...
  return (
    <div>
      <h1 className="text-[#006AFF] md:text-[72px] text-[62px] md:leading-[90px] leading-[72px] font-semibold text-center py-[48px]">
        About eequate
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-4 gap-[20px] md:p-[48px] w-full mx-auto lg:px-[48px] px-[20px]">
        ...
        <div className="flex flex-col md:gap-[54px] gap-[20px]">
          <Card className=" relative bg-black text-white rounded-[30px] h-[200px] overflow-hidden bg-[url('/assets/images/a1.webp')] bg-cover bg-center">
            {/* Black overlay */}
        ...
        <div className="flex flex-col md:gap-[54px] gap-[20px]">
          ...
          <Card className="relative bg-black text-white rounded-[30px] h-[200px] overflow-hidden bg-[url('/assets/images/a5.webp')] bg-cover bg-center">
            {/* Black overlay */}
            <div className="absolute inset-0 bg-black/50"></div>
            <CardContent className="relative flex flex-col justify-between h-full p-[24px] gap-[27px]">
              <h3 className="text-[32px] leading-[41.6px] font-semibold">
      ...
      <div className="md:px-[48px] md:py-[60px] px-[20px] py-[20px] lg:mt-0 mt-10 flex flex-col gap-[48px]">
        <h2 className=" md:text-[48px] sm:text-[32px] text-[28px] font-semibold md:leading-[62px] sm:leading-[48px] leading-[40px] text-center">
          Bringing <span className="text-[#006AFF]">expertise</span> to every
          interaction
        </h2>
      ...
      <div className="md:px-[48px] px-5">
        ...
        >
          ...
          <h2 className="font-medium mdLleading-[40px] leading-[32px] md:text-[24px] text-[16px] text-[#FFFFFF]">
            Our mission is to build impactful, user-centered digital solutions
            that empower businesses to thrive while making a positive
            difference. We envision a future where technology and sustainability
            go hand in hand, creating value for our clients, their users, and
            the world at large. Through continuous innovation and a commitment
            to responsible practices, we aim to lead in crafting experiences
      ...
      <div className="flex flex-col gap-[48px] md:py-[60px] py-[20px] md:px-[48px] px-5">
        <div className="text-center flex flex-col">
          <h1 className="md:text-[48px] text-[32px] font-semibold md:leading-[62px] leading-[42px]">
            What our <span className="text-[#006AFF]">customers</span> says
            about us
          </h1>
          <h2 className="text-[#6F849E] text-[15px] md:mt-0 mt-4 leading-[28px] font-medium">
            Our clients appreciate how we blend cutting-edge technology with a
            focus on user experience to deliver solutions that truly resonate.
          </h2>
        </div>
        <div
          ref={scrollRef}
          className="testimonials-slider flex flex-row  overflow-hidden  overflow-x-auto space-x-[10px] scrollbar-hide "
        >
