      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-[73px] gap-10 items-start">
        ...
        <div className="flex flex-col lg:gap-[48px] gap-[32px]">
          <div className="flex flex-col">
            ...
            >
              Turning <span className="text-[#005EFF]">Ideas</span> into
              Engaging <br />
              <span className="text-[#005EFF]">User Experiences</span> That{" "}
              <br />
              Deliver Results
            </h1>
            <p
            ...
            >
              We put user experience at the heart of every project. Our
              innovative solutions are crafted to captivate users and elevate
              satisfaction.
            </p>
          </div>
