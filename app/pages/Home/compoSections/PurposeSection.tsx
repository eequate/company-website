...
const services = [
    {
        ...
        image: "/assets/images/dribble1.svg",
    },
    {
        ...
        image: "/assets/images/dribble2.svg",
    },
    {
        ...
        image: "/assets/images/dribble3.svg",
    },
];
...
export default function PurposeSection() {
    ...
    return (
        <div
            ...
            style={{ backgroundImage: `url(/assets/images/nature.svg)` }}
        >
            {/* Black Overlay */}
            ...
            <div className="relative">
                <h2
                    className="md:text-[48px] text-[28px] md:leading-[62px] leading-[38px] font-semibold font-bold text-center text-white"
                    {...getAosProps("fade-up")}
                >
                    Driven by Purpose, <span className="text-[#99CF63]">Inspired by Nature</span>
                </h2>
                <p
                ...
                >
                    We believe in building a better tomorrow by embracing sustainable practices today. From reducing waste to optimizing energy use, we’re committed to integrating eco-conscious methods into everything we do. Our innovative solutions are designed not just to serve users, but also to protect our planet.
                </p>
