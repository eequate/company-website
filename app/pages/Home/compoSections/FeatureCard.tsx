...
export default function ServiceCard({ image, title, description }: ServiceCardProps) {
    return (
        <Card
            className="relative max-w-[380px] md:h-[380px] h-[320px] bg-gradient-to-b from-black to-gray-900 border-[5px] border-[#77AFFF4D] rounded-none md:rounded-[30px] shadow-lg p-[20px] overflow-hidden card-hover cursor-pointer"
            style={{
        ...
        >
            {/* Black Shade Overlay */}
            <div className="absolute inset-0 bg-black opacity-60 rounded-none md:rounded-[30px]"></div>
