...
const ChooseUsCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <Card className="relative  max-w-[409px] h-[325px] p-[48px] flex flex-col gap-[27px] text-white rounded-[30px]  overflow-hidden">
      {/* Background Image */}
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage: `url(/assets/images/chooseUs.webp)`,
      ...
      <CardContent className="relative flex flex-col gap-[27px] h-full  p-0 z-10">
        <div className="flex flex-col h-full justify-between">
          <h2 className="text-[32px] leading-[41px] font-semibold">
            {heading}
          </h2>
