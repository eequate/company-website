...
export default function page() {
  const services = [
    ...
    },
    {
      ...
      image: "/assets/images/shot1.wbep",
    },
  ];
  ...
  const chooseUsData = [
    {
      ...
      description:
        "We take the time to understand your business and create customized strategies.",
    },
    {
    ...
    },
    {
      ...
      description:
        "From ideation to implementation, we’re with you every step of the way.",
    },
  ];
  return (
    <div className="md:px-[48px] px-0">
      <div>
        <h1 className="text-[#006AFF] text-[72px] leading-[90px] font-semibold text-center px-[48px] py-[48px]">
          Services
        </h1>
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:gap-[54px] gap-[20px]  md:p-[48px] w-full mx-auto md:px-0 px-[20px]">
          ...
          <div className="flex flex-col lg:gap-[54px] gap-[20px]">
            <Card className=" relative bg-black text-white rounded-[30px] lg:h-[200px] h-[240px] overflow-hidden bg-[url('/assets/images/card1.webp')] bg-cover bg-center">
              {/* Black overlay */}
              <div className="absolute inset-0 bg-black/50"></div>
              <CardContent className="relative flex flex-col justify-between h-full p-[24px] gap-[27px]">
                <h3 className="xl:text-[72px] text-[60px] leading-[41.6px] font-semibold">
                  100M+
                </h3>
            ...
            <div className="relative w-full lg:h-[400px] h-[240px] rounded-[30px] overflow-hidden">
              <Card className=" relative bg-black text-white rounded-[30px] lg:h-[400px] h-[240px] overflow-hidden bg-[url('/assets/images/card2.webp')] bg-cover bg-center">
                {/* Black overlay */}
                <div className="absolute inset-0 bg-black/50"></div>
                <CardContent className="relative flex flex-col justify-between h-full p-[24px] gap-[27px]">
                  <h3 className="xl:text-[72px] text-[60px] leading-[41.6px] font-semibold">
          ...
          <div className="relative w-full lg:h-full h-[240px] rounded-[30px] overflow-hidden">
            <Card className=" relative bg-black text-white rounded-[30px] h-full overflow-hidden bg-[url('/assets/images/card3.webp')] bg-cover bg-center">
              {/* Black overlay */}
              <div className="absolute inset-0 bg-black/50"></div>
              <CardContent className="relative flex flex-col justify-between h-full p-0">
                <h3 className="xl:text-[63px] lg:text-[48px] text-[36px] md:leading-[79.38px] py-4 leading-[40px] xl:px-[24px] px-4 font-semibold">
                  Crafting tailored strategies to empower businesses and drive
                  success.
                </h3>
              </CardContent>
            </Card>
          ...
          <div className="flex flex-col lg:gap-[54px] gap-[20px]">
            <div className="relative w-full lg:h-[400px] h-[240px] rounded-[30px] overflow-hidden">
              <Card className=" relative bg-black text-white rounded-[30px] h-[400px] overflow-hidden bg-[url('/assets/images/card4.webp')] bg-cover bg-center">
                {/* Black overlay */}
                <div className="absolute inset-0 bg-black/50"></div>
                <CardContent className="relative flex flex-col justify-between h-full p-[24px] gap-[27px]">
                  <h3 className="xl:text-[72px] text-[60px] leading-[41.6px] font-semibold">
            ...
            <Card className="relative bg-black text-white rounded-[30px] lg:h-[200px] h-[240px] overflow-hidden bg-[url('/assets/images/card5.webp')] bg-cover bg-center">
              {/* Black overlay */}
              <div className="absolute inset-0 bg-black/50"></div>
              <CardContent className="relative flex flex-col justify-between h-full p-[24px] gap-[27px]">
                <h3 className="xl:text-[72px] text-[60px] leading-[41.6px] font-semibold">
      ...
      <div className="text-center md:py-[60px] lg:px-[48px] py-[20px] px-[20px] flex flex-col gap-[48px]">
        <div>
          <h1 className="md:text-[48px] text-[32px] text-[#1F2541] leading-[62px] font-semibold">
            Why Choose Us?
          </h1>
          <p className="text-[#6F849E] text-[16px] leading-[28px] font-medium">
